\begin{table}[h!]
	\centering
	\caption{The yield of \ttbar{} estimated from the data in each bin for each event variable, after the background has been subtracted and fakes removed. The combined total is also shown, where the differences are due to the multijet QCD estimation.}
	\label{tb:ttyields}
	\resizebox{\linewidth}{!}{%
